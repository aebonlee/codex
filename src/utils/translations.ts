export const translations: Record<string, Record<string, unknown>> = {
  ko: {
    ...
    site: {
      ...
      home: {
        title: 'Codex CLI Master',
        subtitle: 'OpenAI Codex CLI 완전 정복 — 터미널에서 AI와 함께 코딩하기',
        welcome: 'Codex CLI란?',
        description: 'OpenAI가 만든 오픈소스 AI 코딩 에이전트입니다. 터미널에서 자연어로 코드를 생성, 수정, 디버그할 수 있으며, 파일 시스템과 셸 명령을 직접 실행합니다.'
      }
    }
  },
  ...
  en: {
    ...
    site: {
      ...
      home: {
        title: 'Codex CLI Master',
        subtitle: 'Master OpenAI Codex CLI — AI-powered coding from your terminal',
        welcome: 'What is Codex CLI?',
        description: 'An open-source AI coding agent by OpenAI. Generate, edit, and debug code using natural language right from your terminal, with direct file system and shell access.'
      }
    }
  }
};
